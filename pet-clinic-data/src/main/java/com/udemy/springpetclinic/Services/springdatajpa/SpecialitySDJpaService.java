...
import com.udemy.springpetclinic.Repositories.ISpecialityRepository;
...
public class SpecialitySDJpaService implements ISpecialityService {

    private final ISpecialityRepository specialityRepository;

    public SpecialitySDJpaService(ISpecialityRepository specialityRepository) {
